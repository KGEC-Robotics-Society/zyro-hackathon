        ...
        <ol className="items-center sm:flex mx-[calc(10vw)] ">
          {data.timelines.map((timeline) => {
            return (
              <li
                key={timeline.id}
                className="relative mb-6 pb-1 sm:w-[calc(14vw)] sm:h-[calc(22vh)] sm:mb-0 backdrop-blur-sm bg-black/50 rounded-md sm:rounded-none"
              >
                ...
                <div className="mt-1 sm:mt-3 sm:pr-8">
                  ...
                  <p className="text-base font-normal text-gray-400 m-5">
